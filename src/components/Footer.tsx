        ...
        <div className="footer-contact-column">
          ...
          <div className="footer-contact-items">
            <div className="footer-contact-item">
              <Phone size={14} />
              <a href="tel:+918955535550">+91 89555 35550 (Jagtial)</a>
            </div>
            <div className="footer-contact-item">
              <Phone size={14} />
              <a href="tel:+919700063333">+91 97000 63333 (Metpally)</a>
            </div>
            <div className="footer-contact-item">
              <Mail size={14} />
              <a href="mailto:jagtial@mahafurnitures.mahafurnitures.com">jagtial@mahafurnitures.mahafurnitures.com</a>
            </div>
            <div className="footer-contact-item">
              <MapPin size={14} />
          ...
          <div className="footer-social-row">
            <a href="https://wa.me/918955535550" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="social-icon-btn whatsapp">
